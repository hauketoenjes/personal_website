    ...
    return (
        <header className="body-font">
            <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
                ...
                <nav
                    className="md:mr-auto md:ml-4 md:py-1 md:pl-4 md:border-l md:border-neutral-400 flex flex-wrap items-center text-base justify-center space-x-2">
                    <Button
                        ariaLabel="GitHub"
                        link="https://github.com/hauketoenjes"
                    >
                    ...
                    <Button
                        ariaLabel="Twitter"
                        link="https://twitter.com/hauketoenjes"
                    >
                        <svg width="24" height="24" aria-hidden="true" focusable="false" data-prefix="fab"
                    ...
                    <Button
                        ariaLabel="GitLab"
                        link="https://gitlab.com/hauketoenjes"
                    >
